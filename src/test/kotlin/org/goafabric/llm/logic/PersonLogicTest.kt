...
@SpringBootTest
internal class PersonLogicTest(@Autowired val personLogic: PersonLogic) {
    ...
    fun findByFirstName() {
        ...
        Assertions.assertThat<Address>(person.first().address).hasSize(1)
        Assertions.assertThat<Allergy>(person.first().allergy).hasSize(1)
    }
